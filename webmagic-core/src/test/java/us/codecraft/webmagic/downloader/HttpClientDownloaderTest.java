...
public class HttpClientDownloaderTest {
    ...
    public void testDownloaderInIllegalUrl() {
        HttpClientDownloader httpClientDownloader = new HttpClientDownloader();
    ...
    public void testGetHtmlCharset() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            private String getCharsetByUrl(String url) {
                ...
                try {
                    httpResponse =
                        httpClient.execute(new HttpUriRequestConverter().convert(requestGBK, site, null).getHttpUriRequest());
                }
                catch (IOException e) {
                    e.printStackTrace();
                }
                ...
                try {
                    ...
                    charset =
                        CharsetUtils.detectCharset(httpResponse.getEntity().getContentType().getValue(), contentBytes);
                }
                catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() throws Exception {
                ...
                HttpUriRequest httpUriRequest =
                    httpUriRequestConverter.convert(request, site, null).getHttpUriRequest();
    ...
    public void test_set_site_header() throws Exception {
        ...
        Runner.running(server, new Runnable() {
            ...
            public void run() {
                ...
                request.setUrl("http://127.0.0.1:13423");
                Page page =
                    httpClientDownloader.download(request, Site.me().addHeader("header", "header-webmagic").toTask());
                assertThat(page.getRawText()).isEqualTo("ok");
            }
        });
    }
