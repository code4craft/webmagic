...
public class InfoQMiniBookProcessor implements PageProcessor {
    ...
    public static void main(String[] args) {
        Spider.create(new InfoQMiniBookProcessor()).thread(5).addUrl("http://www.infoq.com/cn/minibooks").run();
    }
    ...
    public Site getSite() {
        if (site == null) {
            site =
                Site.me().setDomain("www.infoq.com").addCookie("RegisteredUserCookie", "sDDDc8dIAgZSq67uJSXhtpQaHEi1XDOH").
